...
mv ~/.android-certs vendor/aosp/keys
echo "PRODUCT_DEFAULT_DEV_CERTIFICATE := vendor/aosp/keys/releasekey" > vendor/aosp/keys/keys.mk

# Create BUILD.bazel file
cat <<EOF > vendor/aosp/keys/BUILD.bazel
filegroup(
...
echo "Done! Now build as usual. If builds aren't being signed, add '-include vendor/aosp/keys/keys.mk' to your device mk file"
echo "Make copies of your vendor/aosp folder or upload it to a private repository as it contains your keys!"
sleep 3
