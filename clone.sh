...
choose_repo_and_branch() {
  ...
  branch=$(select_branch "$repo") || exit 1
...
clone_bramble() {
  ...
  vendor_branch=$(select_branch "https://github.com/TheMuppets/proprietary_vendor_google_bramble.git") || exit 1
  clone_repo "https://github.com/TheMuppets/proprietary_vendor_google_bramble.git" "vendor/google/bramble" "$vendor_branch"
...
clone_coral() {
  ...
  echo
  echo "Cloning vendor tree (TheMuppets only)"
  vendor_branch=$(select_branch "https://github.com/TheMuppets/proprietary_vendor_google_coral.git") || exit 1
  clone_repo "https://github.com/TheMuppets/proprietary_vendor_google_coral.git" "vendor/google/coral" "$vendor_branch"
...
clone_flame() {
  ...
  clone_coral
  echo "[INFO] Flame uses Coral tree as device base."
}
...
clone_sunfish() {
  ...
  echo
  echo "Cloning vendor tree (TheMuppets only)"
  vendor_branch=$(select_branch "https://github.com/TheMuppets/proprietary_vendor_google_sunfish.git") || exit 1
  clone_repo "https://github.com/TheMuppets/proprietary_vendor_google_sunfish.git" "vendor/google/sunfish" "$vendor_branch"
